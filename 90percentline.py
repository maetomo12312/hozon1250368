...
def calculate_90th_percentile(dir1, dir2, dir3, dir4):
    ...
    thinking_times.sort()
    percentile_90 = np.percentile(thinking_times, 90)

    print(f"90% ラインの thinking_time: {percentile_90}")
...
dir_path1 = "./Searchresult/Tlong_1688-2006-2"
dir_path2 = "./Searchresult/Tlong_2007-2845-2"
dir_path3 = "./Searchresult/Tlong-test_1688-2006-2"
dir_path4 = "./Searchresult/Tlong-test_2007-2845-2"
