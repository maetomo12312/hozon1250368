...
output_dir = "./predicted_results4/GDSPrate_H"
feature_importance_file = "./predicted_results4/GDSP_H.txt"
# 学習データとテストデータの読み込み
...
for test_dir, test_df in [(test_dir_path, test_data1), (test_dir_path2, test_data2)]:
    for filename in os.listdir(test_dir):
        if filename.endswith(".csv"):
            ...
            test_df_individual['predicted_thinking_time'] = y_test_pred[:len(test_df_individual)]
