...
commands = [
    ...
    #["python", "./testSearch.py", ".\\mcts_player.bat", ".\\usistorage\\Trate_1-735_usi1", ".\\Searchresult", ".\\Rrate_1-735\\SearchR", "100"],
    #["python", "./testSearch.py", ".\\mcts_player.bat", ".\\usistorage\\Trate_1-735_usi2", ".\\Searchresult", ".\\Rrate_1-735\\SearchR", "100"],
    #["python", "./testSearch.py", ".\\mcts_player.bat", ".\\usistorage\\Trate_1-735_usi3", ".\\Searchresult", ".\\Rrate_1-735\\SearchR", "100"],
    #["python", "./testSearch.py", ".\\mcts_player5.bat", ".\\usistorage\\Trate_1688-2006_usiZ", ".\\Searchresult", ".\\RRrate_1688-2006\\SearchR", "100"],
    #["python", "./testSearch.py", ".\\mcts_player.bat", ".\\usistorage\\Trate_1-735_usiZ4", ".\\Searchresult", ".\\RRrate_1-735\\SearchR", "100"],
    ["python", "./testSearch.py", ".\\mcts_player.bat", ".\\usistorage\\Trate_1688-2006_usi4", ".\\Searchresult", ".\\GRrate_1688-2006\\SearchR", "100"],
]
